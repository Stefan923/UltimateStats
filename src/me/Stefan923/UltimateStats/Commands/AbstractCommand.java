...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(UltimateStats instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(UltimateStats instance, CommandSender sender, String... args);
