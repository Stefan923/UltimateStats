...
public class InventorySettingsManager {
    ...
    public void setup(Plugin p) {
        ...
        if (!exists) {
            ...
            config.addDefault("Stats Menu Items.11-player-kills.Item Type", "simple-item");
            config.addDefault("Stats Menu Items.11-player-kills.Slot", 20);
            config.addDefault("Stats Menu Items.11-player-kills.Page", 1);
            config.addDefault("Stats Menu Items.11-player-kills.Display Name", "&7Played Time &8- &e%statistic_hours_played% hours");
            config.addDefault("Stats Menu Items.11-player-kills.Material", "WATCH");
            config.addDefault("Stats Menu Items.11-player-kills.Data", 0);
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Item Type", "simple-item");
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Slot", 21);
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Page", 1);
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Display Name", "&7Damage Dealt &8- &e%statistic_damage_dealt% HP");
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Material", "IRON_SWORD");
            config.addDefault("Stats Menu Items.12-player-damage-dealt.Data", 0);
            config.addDefault("Stats Menu Items.13-player-damage-taken.Item Type", "simple-item");
            config.addDefault("Stats Menu Items.13-player-damage-taken.Slot", 22);
            config.addDefault("Stats Menu Items.13-player-damage-taken.Page", 1);
            config.addDefault("Stats Menu Items.13-player-damage-taken.Display Name", "&7Damage Taken &8- &e%statistic_damage_taken% HP");
            config.addDefault("Stats Menu Items.13-player-damage-taken.Material", "IRON_CHESTPLATE");
            config.addDefault("Stats Menu Items.13-player-damage-taken.Data", 0);
            config.addDefault("Stats Menu Items.14-player-island-level.Item Type", "simple-item");
            config.addDefault("Stats Menu Items.14-player-island-level.Slot", 23);
            config.addDefault("Stats Menu Items.14-player-island-level.Page", 1);
            config.addDefault("Stats Menu Items.14-player-island-level.Display Name", "&7Island Level &8- &e%askyblock_level%");
            config.addDefault("Stats Menu Items.14-player-island-level.Material", "EXP_BOTTLE");
            config.addDefault("Stats Menu Items.14-player-island-level.Data", 0);
            config.addDefault("Stats Menu Items.15-player-walked-distance.Item Type", "simple-item");
            config.addDefault("Stats Menu Items.15-player-walked-distance.Slot", 24);
            config.addDefault("Stats Menu Items.15-player-walked-distance.Page", 1);
            config.addDefault("Stats Menu Items.15-player-walked-distance.Display Name", "&7Walked Distance &8- &e%statistic_walk_one_cm%");
            config.addDefault("Stats Menu Items.15-player-walked-distance.Material", "MINECART");
            config.addDefault("Stats Menu Items.15-player-walked-distance.Data", 0);
            config.addDefault("Stats Menu Items.16-next-page-1.Item Type", "open-page");
            config.addDefault("Stats Menu Items.16-next-page-1.Next Page", 1);
            config.addDefault("Stats Menu Items.16-next-page-1.Slot", 50);
            config.addDefault("Stats Menu Items.16-next-page-1.Page", 0);
            config.addDefault("Stats Menu Items.16-next-page-1.Display Name", "&aNext Page");
            config.addDefault("Stats Menu Items.16-next-page-1.Material", "ARROW");
            config.addDefault("Stats Menu Items.16-next-page-1.Data", 0);
            config.addDefault("Stats Menu Items.16-next-page-1.Lore", Arrays.asList("", "&7&o- Go to next page."));
            config.addDefault("Stats Menu Items.17-next-page-1.Item Type", "open-page");
            config.addDefault("Stats Menu Items.17-next-page-1.Next Page", 0);
            config.addDefault("Stats Menu Items.17-next-page-1.Slot", 48);
            config.addDefault("Stats Menu Items.17-next-page-1.Page", 1);
            config.addDefault("Stats Menu Items.17-next-page-1.Display Name", "&aPrevious Page");
            config.addDefault("Stats Menu Items.17-next-page-1.Material", "ARROW");
            config.addDefault("Stats Menu Items.17-next-page-1.Data", 0);
            config.addDefault("Stats Menu Items.17-next-page-1.Lore", Arrays.asList("", "&7&o- Go to previous page."));
            config.addDefault("Stats Menu Items.18-next-page-1.Item Type", "close-page");
            config.addDefault("Stats Menu Items.18-next-page-1.Slot", 49);
            config.addDefault("Stats Menu Items.18-next-page-1.Page", 0);
            config.addDefault("Stats Menu Items.18-next-page-1.Display Name", "&cClose");
            config.addDefault("Stats Menu Items.18-next-page-1.Material", "BARRIER");
            config.addDefault("Stats Menu Items.18-next-page-1.Data", 0);
            config.addDefault("Stats Menu Items.18-next-page-1.Lore", Arrays.asList("", "&7&o- Close the stats menu."));
            config.addDefault("Stats Menu Items.19-next-page-1.Item Type", "close-page");
            config.addDefault("Stats Menu Items.19-next-page-1.Slot", 49);
            config.addDefault("Stats Menu Items.19-next-page-1.Page", 1);
            config.addDefault("Stats Menu Items.19-next-page-1.Display Name", "&cClose");
            config.addDefault("Stats Menu Items.19-next-page-1.Material", "BARRIER");
            config.addDefault("Stats Menu Items.19-next-page-1.Data", 0);
            config.addDefault("Stats Menu Items.19-next-page-1.Lore", Arrays.asList("", "&7&o- Close the stats menu."));
        }
